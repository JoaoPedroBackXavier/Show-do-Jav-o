            ...
            for (int i = 0; i < 10; i++) {
                ...
                if (respoUsu.toLowerCase().charAt(0) == pergunta.getRespostaCerta()) {
                    ...
                    if (i != 9) {
                        ...
                        System.out.println("atualmente o premio esta em .J.J " + premio + " se voce errar a proxima questao, voce leva pra casa .J.J " + premio / 2 + ", \"p\" para parar ou qualquer coisa para continuar.");
                    ...
                    if (premio > 0) {
                        System.out.println("voce errou a questao e vai levar a metade do que voce tinha que foi .J.J " + premio + ", essa quantia equivale a RS " + premio * 0.000064 + ".");
                    } else {
                        System.out.println("voce errou a questao e vai levar a metade do que voce tinha que foi nada seu miseravel.");
                    }
